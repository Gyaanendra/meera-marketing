...
export default function AboutPage() {
  ...
  return (
    <main ref={containerRef} style={{ paddingTop: '6rem' }}>
      ...
      {/* ── Hero ── */}
      <section style={{ padding: 'var(--space-9) var(--space-5)', position: 'relative', overflow: 'hidden' }}>
        {/* Decorative shapes */}
          ...
          <div className="reveal" style={{
            ...
            {pillars.map((p, i) => (
              <div key={i} style={{
                ...
                <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '0.9rem' }}>{p.title}</h2>
        ...
        <div className="content-grid">
          <div className="reveal" style={{ textAlign: 'center', padding: 'var(--space-7)', background: 'var(--color-bg-raised)', border: '1px solid var(--color-line)', borderRadius: 'var(--radius-ui)' }}>
            ...
            <p style={{ fontSize: '0.8rem', color: 'var(--color-ink-soft)', lineHeight: 1.5, marginBottom: '1.25rem', maxWidth: '40ch', marginLeft: 'auto', marginRight: 'auto' }}>
              We build infrastructure for high-stakes environments. Reach out if you want to work with us or learn more about what we do.
            </p>
            <div style={{ display: 'flex', justifyContent: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
              <Link href="/contact" className="btn-primary" style={{ fontSize: '0.8rem', padding: '0.6rem 1.25rem', textDecoration: 'none' }}>Contact us</Link>
